...
// experimental/lazy/import for external lazy bundle generated by standalone build
// experimental/lazy/lynx for lazy bundle generated auto with main bundle
fn create_lazy_import_decl(runtime_pkg: &str, name: &str) -> ModuleItem {
  ...
  C: Comments,
{
  ...
  fn visit_mut_module(&mut self, n: &mut Module) {
    ...
    if !self.named_imports.is_empty() {
      ...
      prepend_stmt(
        &mut n.body,
        create_lazy_import_decl(&self.opts.runtime_pkg, "import"),
      );
    }
    if self.has_inner_lazy_bundle {
      prepend_stmt(
        &mut n.body,
        create_lazy_import_decl(&self.opts.runtime_pkg, "lynx"),
      );
    }
  }
}
